...
export function Home() {
  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-64px)] max-w-7xl flex-col gap-8 px-6 py-10">
      <section className="rounded-[2.5rem] border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-950 p-10 shadow-2xl shadow-black/5 dark:shadow-black/25">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="rounded-[2rem] border border-slate-200 dark:border-gray-800 bg-slate-50 dark:bg-gray-900 p-8 text-center shadow-xl shadow-black/5 dark:shadow-black/20">
            ...
            <div className="mt-6 space-y-6">
              ...
              {selectedFile && (
                <div className="flex items-center gap-3 rounded-2xl border border-slate-200 dark:border-gray-800 bg-slate-100 dark:bg-gray-950/60 px-4 py-3 text-sm text-slate-600 dark:text-gray-300">
                  ...
                  <button
                    ...
                    className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-red-500/30 bg-red-500/10 text-red-600 transition hover:border-red-400 hover:bg-red-500/20 hover:text-red-700 disabled:cursor-not-allowed disabled:opacity-50 dark:text-red-200 dark:hover:text-white"
      ...
      {needsExperienceInput && (
        <section className="rounded-[2rem] border border-amber-500/30 bg-amber-100 dark:bg-amber-950/40 p-6 text-amber-900 dark:text-amber-50 shadow-lg shadow-black/5 dark:shadow-black/20">
          <h2 className="text-lg font-semibold">Select your experience level</h2>
          <p className="mt-2 text-sm text-amber-800/80 dark:text-amber-100/80">The parser could not determine your experience automatically. Pick the closest match so we can continue.</p>
